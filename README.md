...
2. Zachowanie obiektu orbitującego blisko horyzontu zdażeń.
...
* Definitywna odpowiedź czy jeżeli obiekty przelecą bardzo blisko siebie przekraczając masę kryytyczną to czy są w stanie się uwolnić od powstałej czarnej dziury? (pewnie tylko fragment będący poza horyzontem zdarzeń)
...
* Prominiowanie higgsa energia/intensywność w zależności od bliskości do czarnej dziury.
